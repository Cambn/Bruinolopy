...
void subWindow::GoSettingPage2(){
    ...
    QStringList defaultname={"A","B","C","D"};
    ...
    for (int _numberofplayer = 0 ; _numberofplayer < window2->num_player ; ++_numberofplayer){
        ...
        txt->setText(defaultname[_numberofplayer]);

        window2->LElist.append(txt);
        window2->layout_forUpdate[_numberofplayer]->addWidget(txt);
        window2->layout_forUpdate[_numberofplayer]->addWidget(warningLabel_name);

        //ComboBox
        QComboBox *combobox = new QComboBox(this);
        combobox->setMaximumSize(200,50);
        combobox->addItem(QIcon(":/fig/panda.png"),"Panda");
        combobox->addItem(QIcon(":/fig/brown bear.png"),"Brown Bear");
        combobox->addItem(QIcon(":/fig/polar bear.png"),"Polar Bear");
        combobox->addItem(QIcon(":/fig/grey bear.png"),"Grey Bear");
