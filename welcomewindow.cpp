...
void WelcomeWindow::GoSettingPage(){
    ...
    game_setup->setAttribute( Qt::WA_DeleteOnClose, true ); // Widget will be deleted automatically when closed
...
void WelcomeWindow::GoRulePage(){
    ...
    a->setAttribute( Qt::WA_DeleteOnClose, true ); // Widget will be deleted automatically when closed
